...
const Mkt5009RoutedVDHCPVB = () => {
  ...
  return (
    <div className='template'>
      <h2>Mikrotik - 5009 Routed - with Voice DHCP Server Voice Bridge</h2>
      <pre>
...
add action=dst-nat chain=dstnat dst-port=2222 in-interface=ether1 port="" protocol=tcp src-address-list=Vervecloud to-addresses=192.168.25.2 to-ports=22
...
export default Mkt5009RoutedVDHCPVB;
