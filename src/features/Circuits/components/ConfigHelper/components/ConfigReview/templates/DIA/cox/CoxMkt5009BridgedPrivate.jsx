...
const CoxMkt5009BridgedPrivate = () => {
  const {
    theme,
    clientName,
    carrier,
  ...
  return (
    <div className='template'>
      <h2>Cox Mikrotik - 5009 Bridged with Private switch</h2>
...
add action=accept chain=input dst-port=2222 log=yes protocol=tcp
...
export default CoxMkt5009BridgedPrivate;
