...
const CoxMkt5009BridgedPrivateTP = () => {
  ...
  return (
    <div className='template'>
      <h2>Cox Mikrotik - 5009 Bridged with Private TP-Link switch</h2>
      <pre>
...
add name=WAN_Bridge
/interface ethernet
set [ find default-name=ether1 ] advertise=100M-baseT-half,100M-baseT-full,1G-baseT-half,1G-baseT-full
/interface vlan
...
add action=dst-nat chain=dstnat dst-port=8080 in-interface=WAN_Bridge port="" protocol=tcp to-addresses=192.168.25.2 to-ports=80
...
export default CoxMkt5009BridgedPrivateTP;
