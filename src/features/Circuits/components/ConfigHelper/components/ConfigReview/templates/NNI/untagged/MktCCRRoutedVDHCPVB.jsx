...
const MktCCRRoutedVDHCPVB = () => {
  ...
  return (
    <div className='template'>
      <h2>Mikrotik - CCR Routed - with Voice DHCP Server Voice Bridge</h2>
      <pre>
...
/ip dhcp-server
add address-pool=dhcp_pool1 disabled=no interface=sfp-sfpplus3 name=dhcp1
...
add action=dst-nat chain=dstnat dst-port=2222 in-interface=sfp-sfpplus1 port="" protocol=tcp src-address-list=Vervecloud to-addresses=192.168.25.2 to-ports=22
...
export default MktCCRRoutedVDHCPVB;
