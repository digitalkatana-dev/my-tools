...
const Mkt5009RoutedSwitchSub = () => {
  ...
  return (
    <div className='template'>
      <h2>Mikrotik - 5009 Routed with switch - subinterface</h2>
      <pre>
        <p className='config-details'>
          {`/interface bridge
add name=Voice_Bridge
/interface vlan
add interface=ether1 name=`}
...
add action=dst-nat chain=dstnat dst-port=2222 in-interface=`}
          ...
          {` port="" protocol=tcp src-address-list=Vervecloud to-addresses=192.168.25.2 to-ports=22
...
export default Mkt5009RoutedSwitchSub;
